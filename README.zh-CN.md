...
这是一个开源的 [Vibe Island](https://vibeisland.app/) 替代品，面向 macOS 上的重度 code agent 用户。目前支持 **Claude Code** 和 **Codex**，终端集成覆盖 **Terminal.app**、**Ghostty**，并对 iTerm2、Warp、WezTerm、cmux 提供降级检测支持。
...
- **Terminal.app** 和 **Ghostty** — 完整的 jump-back 支持，带会话附着匹配
- **iTerm2、Warp、WezTerm、cmux** — 降级检测和基本进程发现
